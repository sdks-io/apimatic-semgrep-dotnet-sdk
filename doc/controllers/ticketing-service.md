...
```csharp
TicketingServiceDeleteTicketAsync(
    string deploymentId,
...
try
{
    ApiResponse<ProtosOpenapiV1DeleteTicketResponse> result = await ticketingServiceApi.TicketingServiceDeleteTicketAsync(
        deploymentId,
        externalTicketId
    );
}
...
```csharp
TicketingServiceLinkTicketAsync(
    string deploymentId,
...
try
{
    ApiResponse<ProtosOpenapiV1LinkTicketResponse> result = await ticketingServiceApi.TicketingServiceLinkTicketAsync(
        deploymentId,
        body
    );
}
...
```csharp
TicketingServiceUnlinkTicketAsync(
    string deploymentId,
...
try
{
    ApiResponse<ProtosOpenapiV1UnlinkTicketResponse> result = await ticketingServiceApi.TicketingServiceUnlinkTicketAsync(
        deploymentId,
        body
    );
}
...
```csharp
TicketingServiceCreateTicketAsync(
...
try
{
    ApiResponse<ProtosOpenapiV1CreateTicketResponse> result = await ticketingServiceApi.TicketingServiceCreateTicketAsync(
        deploymentSlug,
        body
    );
}
